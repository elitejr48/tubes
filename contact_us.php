      ...
      <div class="modal-dialog">
        ...
        <div class="modal-content">
          ...
          <div class="background" >
            <div class="transbox" align="center" style="background:gray;opacity:0.9;padding-bottom:200px" >
              <div class="header">
                  ...
                  <form>
                      <table class="margin" cellspacing="50px" border-spacing="15px">
                          <tr>
                              <td>
                                  <p>*Full Name</p>
                                  <input style="color:black" type="text" id="name" name="Input">
                              </td>
                              <td>
                                  <p>*Organisation Name</p>
                                  <input style="color:black" type="text" id="orgInput" name= "orgInput">
                              </td>
                              <td rowspan="2">
                                  <p>Message</p>
                                  <textarea style="color:black" class="TEXT" type="text" id="message" name="message">
                                  </textarea>
                              </td>
                          </tr>
                          <tr>
                              <td>
                                  <p>*Email</p>
                                  <input style="color:black" type="text" id ="emailInput" name="emailInput">
                              </td>
                              <td>
                                  <p>*Phone</p>
                                  <input style="color:black" type="text" id="phoneInput" name="phoneInput">
                              </td>
                              <td></td>
                          </tr>
                          <tr>
